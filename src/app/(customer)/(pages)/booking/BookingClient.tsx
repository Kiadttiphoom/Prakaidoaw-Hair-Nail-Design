...
import { Calendar, Clock, User, Phone, Mail, ChevronRight, Check, ShieldAlert } from "lucide-react";
...
export default function BookingClient({ stylists: initialStylists, isAuth }: BookingClientProps) {
                      ...
                      >
                        ...
                        <div className="relative h-48 sm:h-56 overflow-hidden bg-gray-100">
                          <Image
                            ...
                            alt={`รูปภาพบริการ ${service.title}`}
                            aria-hidden="true"
                            width={400}
                            height={400}
