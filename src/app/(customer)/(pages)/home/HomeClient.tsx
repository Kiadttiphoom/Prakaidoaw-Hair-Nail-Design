...
export default function HomeClient({ services, stylists, reviews }: Props) {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center px-8 max-w-6xl">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5 animate-[fadeInUp_1.5s_ease-out_0.9s_both]">
            ...
            >
              ดูบริการทั้งหมด
              <ArrowRight className="w-5 h-5 group-hover:translate-x-2 transition-transform duration-700" strokeWidth={1.5} />
            </a>
          </div>
        </div>
      ...
      <section id="services" className="sm:py-24 py-12 bg-gradient-to-b from-white via-gray-50/40 to-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto sm:px-8 px-4 relative z-10">
          ...
          >
            ...
            <p className="text-gray-400 text-[10px] sm:text-xs tracking-[0.5em] mb-10 font-light uppercase">Our Services</p>
            <h2 className="text-4xl sm:text-6xl text-gray-900 font-extralight tracking-tight mb-8 leading-none">บริการของเรา</h2>
      ...
      <section className="sm:py-24 py-12 bg-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto sm:px-8 px-4 relative z-10">
          ...
          <div className="flex sm:grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 overflow-x-auto sm:overflow-visible snap-x snap-mandatory scrollbar-hide">
            {reviews.map((item, index) => (
              ...
              >
                <div className="flex flex-col items-center mb-8">
                  <span className="text-gray-900 font-light tracking-wide text-base sm:text-lg mb-2">{item.name}</span>
                  <div className="flex gap-1 justify-center">
                    {[...Array(item.rating)].map((_, i) => (
                      <Star key={i} className="w-5 h-5 sm:w-6 sm:h-6 text-amber-400 fill-amber-400" strokeWidth={0.5} />
                    ))}
                  </div>
                </div>
                <p className="text-gray-600 font-light leading-relaxed text-base sm:text-lg">"{item.comment}"</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Stylists */}
      <section id="stylists" className="sm:py-24 py-12 bg-gradient-to-b from-gray-50/50 via-white to-gray-50/50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto sm:px-8 px-4 relative z-10">
          <div
                    ...
                    <div className="relative mb-8 overflow-hidden rounded-[2rem] shadow-lg">
                      ...
                      <div className={`absolute bottom-0 left-0 right-0 p-6 transition-transform duration-700 ${
                        ...
                        <div className="bg-white/98 backdrop-blur-xl rounded-[1.5rem] p-6 border border-gray-100/80 shadow-2xl">
                          ...
                          <p className="text-gray-500 text-xs font-light mb-2">ประสบการณ์ {stylist.experience_years} ปี</p>
                          <p className="text-gray-500 text-sm font-light leading-relaxed">{stylist.description}</p>
                        </div>
                      </div>
                    </div>

                    <div className={`transition-opacity duration-700 ${isActive ? "opacity-0" : "group-hover:opacity-0"}`}>
                      <h3 className="text-2xl text-gray-900 mb-2 font-extralight tracking-wide">{stylist.name}</h3>
                      <p className="text-gray-500 text-sm mb-1 font-light tracking-wider">{stylist.specialty}</p>
                      <p className="text-gray-400 text-xs font-light tracking-wide">ประสบการณ์ {stylist.experience_years} ปี</p>
                    </div>
                  </div>
                );
              })}
            ...
            {stylists.map((stylist: any, index: number) => (
              ...
              >
                <div className="relative mb-10 overflow-hidden rounded-[2rem] shadow-lg">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-10 translate-y-full group-hover:translate-y-0 transition-transform duration-1000">
                    <div className="bg-white/98 backdrop-blur-xl rounded-[1.5rem] p-8 border border-gray-100/80 shadow-2xl">
                      <h3 className="text-3xl text-gray-900 mb-3 font-extralight tracking-wide">{stylist.name}</h3>
                      <p className="text-gray-600 text-base mb-2 font-light tracking-wider">{stylist.specialty}</p>
                      <p className="text-gray-500 text-sm font-light mb-4">ประสบการณ์ {stylist.experience_years} ปี</p>
                      <p className="text-gray-500 text-sm font-light leading-relaxed">{stylist.description}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group-hover:opacity-0 transition-opacity duration-700">
                  <h3 className="text-3xl text-gray-900 mb-4 font-extralight tracking-wide">{stylist.name}</h3>
                  <p className="text-gray-500 text-base mb-2 font-light tracking-wider">{stylist.specialty}</p>
                  <p className="text-gray-400 text-sm font-light tracking-wide">ประสบการณ์ {stylist.experience_years} ปี</p>
                </div>
              </div>
            ))}
          </div>
